    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} action="" className="w-full">
                <div className="">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input {...register("Name", {required: "Please enter your name!!"})} type="text" id="" className="w-full p-2.5 outline-none rounded-sm mt-1 font-light placeholder-slate-400 bg-indigo-50" placeholder="John Doe"/>
                ...
                <input type="submit" value="Register" className="h-10 w-full bg-[--primary-color] rounded-sm text-white mb-3 mt-12 cursor-pointer"/>
                <Link to='/login' className="h-10 w-full grid place-items-center rounded-sm border-solid border border-indigo-500 text-indigo-500">Login</Link>
            </form>
        </>
    )
}
